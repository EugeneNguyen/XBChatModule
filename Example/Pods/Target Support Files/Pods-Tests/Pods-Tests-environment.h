...
// XBChatModule
#define COCOAPODS_POD_AVAILABLE_XBChatModule
#define COCOAPODS_VERSION_MAJOR_XBChatModule 0
#define COCOAPODS_VERSION_MINOR_XBChatModule 1
#define COCOAPODS_VERSION_PATCH_XBChatModule 1
